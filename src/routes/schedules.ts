...
import { listSchedules, listSchedulesByRange, searchSchedules, getSchedule, createSchedule, updateSchedule, deleteSchedule, updateScheduleStatus } from '../controllers/scheduleController';
...
router.get('/search', requireAuth, searchSchedules);
